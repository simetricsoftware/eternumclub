				...
				<table width="600" cellpadding="0" cellspacing="0" border="0">
					...
					<tr>
						<td align="center" style="padding: 0 0 20px 0;">
							<img src="{{ asset('assets/images/lachavizav.webp') }}" alt="La Chaviza" width="800" style="max-width: 70%; margin-top: 25px;" />
						</td>
					</tr>
					<!-- QR Code -->
					<tr>
						<td align="center" style="padding: 0 0 20px 0;">
							<img src="{{ $qr_url }}" alt="QR Code" width="200" style="max-width: 33%;" />
						</td>
					</tr>
					<!-- Message -->
					<tr>
