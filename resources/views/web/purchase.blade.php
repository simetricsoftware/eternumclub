...
<script>
  ...
  function prepare(e)
  {
      ...
      body.append('amountWithoutTax', 100)
      body.append('clientTransactionID', hash)
      body.append('responseUrl', `https://localhost/request-qr?hash=${hash}&name=${name}&email=${email}&phone=${phone}`)
      body.append('cancellationUrl', "https://localhost/request-qr")
